...
This example code is pulled directly from the [AWS CDK examples](https://github.com/aws-samples/aws-cdk-examples/blob/master/typescript/ec2-instance/README.md) repo, for the purposes of demonstrating limitations and security quirks of the CDK bootstrap stacks.
